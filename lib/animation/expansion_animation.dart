...
class ExpansionAnimation extends StatefulWidget {
  final Widget child;
  final bool expand;
  const ExpansionAnimation({super.key, this.expand = false, required this.child});

  @override
  State<ExpansionAnimation> createState() => _ExpansionAnimationState();
}

class _ExpansionAnimationState extends State<ExpansionAnimation> with SingleTickerProviderStateMixin {
